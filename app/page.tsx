const services = [
  {
    ...
    text: "Discreet close protection for executives, diplomats, VIP guests, and international teams.",
    className: "serviceExecutive",
  },
  {
    number: "02",
    title: "Airport & Crew Security",
    text: "Airport coordination, crew protection, secure hotel transfers, and aviation support.",
    className: "serviceAirport",
  },
  {
    number: "03",
    title: "Secure Transportation",
    text: "Professional drivers, secure transfers, route planning, and convoy coordination.",
    className: "serviceTransport",
  },
  {
    number: "04",
    title: "Corporate Security",
    text: "Security planning for offices, projects, conferences, and visiting business teams.",
    className: "serviceCorporate",
  },
  {
    number: "05",
    title: "Journey Management",
    text: "Route assessment, movement tracking, contingency planning, and emergency support.",
    className: "serviceJourney",
  },
  {
    number: "06",
    title: "Security Consulting",
    text: "Risk assessments, travel security plans, security audits, and crisis preparedness.",
    className: "serviceConsulting",
  },
];
    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="heroContent">
          ...
          <h1>
            Security solutions tailored for <span>international operations.</span>
          </h1>
          <p className="lead">
            Professional protection, secure transportation, and aviation security coordination for executives, crews, and corporate teams operating across Nigeria.
          </p>
          <div className="actions">
            <a className="button primary" href="#contact">Request Protection</a>
            <a className="button secondary" href="mailto:globalaviasolutions@gmail.com">Talk to an Expert</a>
          </div>
      ...
      <section className="stats" aria-label="Service highlights">
        ...
        <div><strong>100%</strong><span>Discretion Focus</span></div>
      </section>
      ...
      <section className="section" id="services">
        <div className="sectionHeading twoColumnHeading">
          ...
          <p>
            Every assignment is planned around location, timing, client profile, route, operational requirements, and assessed risk.
          </p>
        </div>
      ...
      <section className="darkSection" id="process">
        <div className="sectionHeading">
          ...
          <p>One point of contact from the first briefing through mission completion.</p>
        </div>
        <div className="processGrid">
          {[
            ["01", "Briefing", "Share the location, timing, passenger profile, and required support."],
      ...
      <section className="industriesSection">
        <div className="sectionHeading">
          ...
          <h2>Built for international operations.</h2>
        </div>
      ...
      <section className="coverageSection" id="coverage">
        <div className="coverageVisual">
          ...
          <div className="mapLabel">Nigeria</div>
        </div>
        <div className="coverageCopy">
          <p className="eyebrow">Nationwide coverage</p>
          <h2>Operating across Nigeria.</h2>
          <p>
            Security coordination is available in major commercial and aviation hubs, subject to partner availability and operational assessment.
          </p>
          <div className="cityGrid">
            {cities.map((city) => <span key={city}>{city}</span>)}
          </div>
          <a className="textLink" href="#contact">Plan an operation →</a>
        </div>
      </section>

      <section className="splitSection" id="about">
        <div className="imagePanel">
          <div className="imageCaption">Aviation-focused security coordination</div>
        </div>
      ...
      <section className="contactSection" id="contact">
        ...
        <div className="contactActions">
          <a className="button primary" href="mailto:globalaviasolutions@gmail.com?subject=Security%20assistance%20request">Email our team</a>
          <a className="button secondary" href="https://wa.me/2340000000000" target="_blank" rel="noreferrer">WhatsApp</a>
        </div>
      </section>
      ...
      <footer>
        <div className="footerGrid">
          <div>
            <img src="/logo.svg" alt="Global Avia Solution" />
            <p>Premium security coordination, secure transportation, and aviation support across Nigeria.</p>
          </div>
          <div>
            <h4>Services</h4>
            <a href="#services">Executive Protection</a>
            <a href="#services">Airport & Crew Security</a>
            <a href="#services">Secure Transportation</a>
          </div>
          <div>
            <h4>Company</h4>
        ...
        <div className="footerBottom">
          <small>© 2026 Global Avia Solution. All rights reserved.</small>
          <small>Temporary development website. Licensing and service claims must be verified before commercial launch.</small>
        </div>
      </footer>
