  ...
  return (
    <main>
      <header className="siteHeader">
        ...
        <nav>
          <a href="#services">Services</a><a href="#process">How It Works</a><a href="#coverage">Coverage</a><a href="/about">About</a><a href="/contact">Contact</a><a className="navCta" href="/contact">Request Protection</a>
        </nav>
      </header>
        ...
        <div className="serviceGrid">
          {services.map((service) => (
            <article className={`serviceCard ${service.className}`} key={service.title}>
              ...
              <div className="serviceBody"><span>{service.number}</span><h3>{service.title}</h3><p>{service.text}</p><a href={service.href}>Explore service →</a></div>
            </article>
          ))}
        </div>
      </section>
