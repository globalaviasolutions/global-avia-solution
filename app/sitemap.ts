...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    "","/about","/contact","/faq","/careers","/privacy","/terms","/services","/industries","/coverage",
  ...
  return routes.map((route)=>({url:`${base}${route}`,lastModified:new Date(),changeFrequency:route===""?"weekly":"monthly",priority:route===""?1:route==="/contact"?0.9:route==="/services"||route==="/industries"||route==="/coverage"?0.85:0.8}));
}
