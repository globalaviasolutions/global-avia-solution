    ...
    <footer className="globalSiteFooter">
      <div className="footerLead">
        <div>
          ...
          <h2>Security planning for people, travel and operations across Africa.</h2>
        </div>
        <div className="footerLeadActions">
          <a className="button primary" href="/contact">Request consultation</a>
          <a className="button secondary" href="/emergency-response">Urgent request guidance</a>
        </div>
      </div>

      <div className="globalFooterGrid">
        <div className="footerBrandColumn">
          <a href="/" aria-label="Africa Security Solutions home"><img src="/logo.svg" alt="Africa Security Solutions" /></a>
          <p>Executive protection, secure transportation, airport support, journey management and risk consulting across Nigeria and selected West African markets.</p>
        ...
        <div><h3>Company</h3><a href="/about">About</a><a href="/leadership">Leadership Structure</a><a href="/careers">Careers</a><a href="/faq">FAQ</a><a href="/contact">Contact</a><a href="/privacy">Privacy Policy</a><a href="/terms">Terms of Use</a></div>
      </div>

      <div className="globalFooterBottom">
        <small>© {year} Africa Security Solutions. All rights reserved.</small>
        <small>Services remain subject to assessment, lawful availability, local requirements and written confirmation.</small>
